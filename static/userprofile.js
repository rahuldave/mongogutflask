...
(function() {
  var $, Postable, PostableList, PostableListView, PostableView, h, make_postable_link, parse_userinfo, root, w,
  ...
  make_postable_link = h.renderable(function(fqpn) {
    h.a({
      href: "/postable/" + fqpn + "/profile/html"
    }, function() {
      return h.text(fqpn);
    });
    h.raw("&nbsp;(");
    h.a({
      href: "/postable/" + fqpn + "/filter/html"
    }, function() {
      return h.text("items");
    });
    return h.raw(")");
