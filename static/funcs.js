...
(function() {
  var $, add_libs_and_groups, dd, dl, dt, format_items, format_notes_for_item, format_postings_for_item, format_tags, format_tags_for_item, get_taggings, get_tags, group_info_template, li, library_info_template, postable_info, postable_info_layout, postable_members, postable_members_template, renderable, root, ul, w,
  ...
  postable_members_template = renderable(function(users) {
    var k, userlist, v;
    userlist = (function() {
      var _results;
      _results = [];
  ...
  postable_members = function(data, template) {
