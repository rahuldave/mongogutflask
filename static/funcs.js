...
(function() {
  var $, AddGroup, InviteUser, add_libs_and_groups, dd, dl, dt, format_items, format_notes_for_item, format_postings_for_item, format_stuff, format_tags, format_tags_for_item, get_taggings, get_tags, group_info_template, li, library_info_template, postable_info, postable_info_layout, postable_inviteds, postable_inviteds_template, renderable, root, ul, w,
  ...
  add_libs_and_groups = function(nick) {
    return $.get("/user/" + nick + "/groupsuserisin", function(data) {
      var groups;
      groups = data.groups;
