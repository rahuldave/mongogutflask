...
class WhosTestCase(unittest.TestCase):

	def setUp(self):
		simple.adsgut.config['TESTING'] = True
		self.app = simple.adsgut.test_client()
	...
	def test_user_endpoints(self):
		...
		print self.getHelper(prefix, '/appsuserisin')
		print self.getHelper(prefix, '/appsuserisinvitedto')
		print self.getHelper(prefix, '/appsuserowns')

		print self.getHelper(prefix, '/groupsuserisin')
		print self.getHelper(prefix, '/groupsuserisinvitedto')
		print self.getHelper(prefix, '/groupsuserowns')
		assert 1
